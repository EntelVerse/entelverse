...
export function Footer() {
    ...
    return (<footer className="bg-base dark:bg-base border-t border-border dark:border-border-secondary py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (<li key={link.name}>
                  <a href={link.href} className="text-content-secondary dark:text-content-secondary hover:text-interactive dark:hover:text-interactive transition-colors">
                    {link.name}
                  </a>
                </li>))}
            </ul>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              {socialLinks.map((link) => (<a key={link.name} href={link.href} target="_blank" rel="noopener noreferrer" className="text-content-secondary dark:text-content-secondary hover:text-interactive dark:hover:text-interactive transition-colors" aria-label={link.name}>
                  {link.icon}
                </a>))}
            </div>
          </div>
