...
export function ChatInterface({ hub }) {
    ...
    return (<div className="p-6">
      ...
      <div className="bg-base-secondary/50 dark:bg-base-secondary/20 rounded-xl p-4 min-h-[50vh] max-h-[60vh] mb-4 overflow-y-auto">
        ...
        {isTyping && (<div className="text-content-secondary dark:text-content-secondary">
      ...
      <div className="flex gap-4">
        ...
        <button onClick={sendMessage} className="px-4 py-3 bg-interactive hover:bg-interactive-hover text-base dark:text-base rounded-xl transition-colors duration-300">
          <Send size={20}/>
        </button>
      </div>
    </div>);
