...
export function ActionCard({ title, description, icon }: ActionCardProps) {
  return (
    <div className="group relative overflow-hidden backdrop-blur-sm rounded-2xl p-6 transition-all duration-300 hover:scale-105 border border-white/10 dark:border-white/5 cursor-pointer">
