      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/20 text-center">
          ...
          <form onSubmit={handleVerifyCode} className="space-y-6 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-white text-center text-2xl tracking-widest"
                maxLength={6}
                pattern="\d{6}"
                required
              />
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          <div className="space-y-4">
            ...
            <button
              className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 disabled:bg-white/5 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
