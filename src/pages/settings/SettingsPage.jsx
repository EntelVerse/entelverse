...
import { Settings, Moon, Globe, Shield, Database } from 'lucide-react';
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <select value={theme} onChange={(e) => setTheme(e.target.value)} className="px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <select value={language} onChange={(e) => setLanguage(e.target.value)} className="px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
