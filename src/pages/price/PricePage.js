...
_jsx("button", { onClick: () => handleSubscribe(plan), className: `w-full py-3 px-4 rounded-lg transition-colors ${plan.recommended
        ? 'bg-blue-500 hover:bg-blue-600 text-white'
        : 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100'}`, children: plan.buttonText });
