      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="relative">
            <input type="text" placeholder="Search for help..." className="w-full px-6 py-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"/>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {guides.map((guide) => (<a key={guide.title} href={guide.link} className="block p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-shadow">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (<div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        ...
        <section>
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-8 text-center">
            ...
            <a href="mailto:support@entelverse.com" className="inline-flex items-center justify-center px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
              Contact Support
            </a>
          </div>
        </section>
