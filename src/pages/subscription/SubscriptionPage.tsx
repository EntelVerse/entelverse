  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {error && (
          <div className="max-w-md mx-auto mb-8 p-4 bg-red-500/10 border border-red-500/20 rounded-lg text-red-500 text-center flex items-center justify-center gap-2">
            <AlertCircle size={20} />
            <span>{error}</span>
          </div>
        )}
        ...
        <div className="flex justify-center items-center gap-4 mb-12">
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-colors ${
              !isYearly ? 'bg-blue-500/10 text-blue-500' : 'hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
            Monthly
          </button>
        ...
        <section>
          <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl p-8 text-center">
            ...
            <a
              href="mailto:sales@entelverse.com"
