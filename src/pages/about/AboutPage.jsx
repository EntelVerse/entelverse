    ...
    return (<div className="min-h-screen pt-24 pb-16">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (<div key={feature.name} className="backdrop-blur-sm bg-base-secondary/50 rounded-2xl p-6 border border-border dark:border-border-secondary hover:scale-105 transition-transform duration-300">
      ...
      <section className="py-16 bg-base-secondary/50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member) => (<div key={member.name} className="backdrop-blur-sm bg-base/50 rounded-2xl overflow-hidden border border-border dark:border-border-secondary hover:scale-105 transition-transform duration-300">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (<div key={index} className="backdrop-blur-sm bg-base-secondary/50 rounded-2xl p-8 border border-border dark:border-border-secondary">
      ...
      <section className="py-16 bg-base-secondary/50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <a href="/signup" className="inline-flex items-center justify-center px-8 py-4 bg-interactive hover:bg-interactive-hover text-base rounded-xl transition-colors">
            Get Started Today
          </a>
        </div>
      </section>
